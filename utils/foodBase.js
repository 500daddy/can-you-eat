...
const foodBase = [
  ...
  food({ id: 'pumpkin', name: '南瓜', aliases: ['贝贝南瓜', '板栗南瓜', '老南瓜'], category: '蔬菜', subCategory: '瓜类', defaultStorage: 'room', icon: assets.food.pumpkin, babyDays: '5-7天', adultDays: '10-15天', babyNote: '切开后请冷藏并尽快做熟。', adultNote: '表面发霉或有异味请处理。', storageTips: ['完整南瓜可阴凉常温保存。', '切开后需要冷藏并尽快食用。', '表面发霉或有异味请处理。'], spoilageSigns: ['发霉', '出水', '软烂', '异味'] }, baseRanges.longRoom),
  ...
  food({ id: 'potato', name: '土豆', aliases: ['马铃薯'], category: '根茎', subCategory: '薯类', defaultStorage: 'room', icon: assets.food.potato, babyDays: '5-7天', adultDays: '10-15天', babyNote: '发芽、发绿或味苦时不要给宝宝食用。', adultNote: '发芽发绿请谨慎处理。', storageTips: ['阴凉避光保存。', '不要和容易释放水分的食材混放。'], spoilageSigns: ['发芽', '发绿', '软烂', '异味'] }, baseRanges.longRoom),
  food({ id: 'sweetPotato', name: '红薯', aliases: ['地瓜', '甘薯'], category: '根茎', subCategory: '薯类', defaultStorage: 'room', icon: assets.food.sweetPotato, babyDays: '5-7天', adultDays: '10-15天', babyNote: '建议蒸熟后观察宝宝接受度。', adultNote: '发霉、黑斑或异味请处理。', storageTips: ['阴凉通风保存。', '切开后请冷藏。'], spoilageSigns: ['发霉', '黑斑', '软烂', '异味'] }, baseRanges.longRoom),
  ...
  food({ id: 'chicken', name: '鸡胸肉', aliases: ['鸡肉'], category: '肉蛋奶', subCategory: '禽肉', defaultStorage: 'freezer', icon: assets.food.chicken, babyDays: '冷藏1天 / 冷冻30天', adultDays: '冷藏2天 / 冷冻90天', babyNote: '必须充分加热，冷藏不宜久放。', adultNote: '异味、发黏或变色请处理。', storageTips: ['冷藏仅短期保存。', '建议分装冷冻，避免反复解冻。'], spoilageSigns: ['异味', '发黏', '变色', '出水'] }, baseRanges.protein),
  food({ id: 'beef', name: '牛肉', aliases: ['牛里脊'], category: '肉蛋奶', subCategory: '畜肉', defaultStorage: 'freezer', icon: assets.food.beef, babyDays: '冷藏1天 / 冷冻30天', adultDays: '冷藏2天 / 冷冻90天', babyNote: '必须充分加热，观察宝宝咀嚼能力。', adultNote: '异味、发黏或明显变色请处理。', storageTips: ['冷藏仅短期保存。', '建议分装冷冻。'], spoilageSigns: ['异味', '发黏', '变色', '出水'] }, baseRanges.protein),
  food({ id: 'fish', name: '鳕鱼', aliases: ['鱼肉', '鱼'], category: '肉蛋奶', subCategory: '水产', defaultStorage: 'freezer', icon: assets.food.fish, babyDays: '冷藏1天 / 冷冻30天', adultDays: '冷藏1-2天 / 冷冻60天', babyNote: '去刺后充分加热。', adultNote: '腥臭、发黏或肉质松散请处理。', storageTips: ['水产建议尽快冷冻。', '解冻后不要反复冷冻。'], spoilageSigns: ['腥臭', '发黏', '变色', '肉质松散'] }, baseRanges.protein),
  food({ id: 'shrimp', name: '虾', aliases: ['鲜虾', '虾仁'], category: '肉蛋奶', subCategory: '水产', defaultStorage: 'freezer', icon: assets.food.shrimp, babyDays: '冷藏1天 / 冷冻30天', adultDays: '冷藏1-2天 / 冷冻60天', babyNote: '确认不过敏后少量尝试并充分加热。', adultNote: '异味、发黑或发黏请处理。', storageTips: ['水产建议尽快冷冻。', '解冻后尽快烹饪。'], spoilageSigns: ['异味', '发黑', '发黏', '出水'] }, baseRanges.protein),
  food({ id: 'tofu', name: '豆腐', aliases: ['嫩豆腐', '老豆腐'], category: '蛋白', subCategory: '豆制品', defaultStorage: 'fridge', icon: assets.food.tofu, babyDays: '1天', adultDays: '2天', babyNote: '开封后建议当天处理。', adultNote: '酸味、发黏或胀包请处理。', storageTips: ['开封后密封冷藏。', '给宝宝食用前充分加热。'], spoilageSigns: ['酸味', '发黏', '胀包', '异味'] }, { ...baseRanges.shortFridge, fridge: { babyDaysMin: 1, babyDaysMax: 1, adultDaysMin: 1, adultDaysMax: 2, text: '开封后密封冷藏并尽快食用。' } }),
  food({ id: 'rice', name: '米饭', aliases: ['熟米饭', '饭'], category: '主食', subCategory: '熟食', defaultStorage: 'fridge', icon: assets.food.rice, babyDays: '1天', adultDays: '1-2天', babyNote: '熟食冷藏后需充分加热。', adultNote: '异味、发黏或放置过久请处理。', storageTips: ['熟米饭常温不建议久放。', '冷藏后充分加热。'], spoilageSigns: ['异味', '发黏', '变干', '霉点'] }, { ...baseRanges.shortFridge, fridge: { babyDaysMin: 1, babyDaysMax: 1, adultDaysMin: 1, adultDaysMax: 2, text: '冷藏后充分加热。' } }),
  food({ id: 'babyPuree', name: '辅食泥', aliases: ['果泥', '菜泥', '肉泥'], category: '主食', subCategory: '辅食', defaultStorage: 'fridge', icon: assets.food.babyPuree, babyDays: '1天', adultDays: '1天', babyNote: '开封或自制后建议当天食用。', adultNote: '异味、分层异常或胀包请处理。', storageTips: ['开封后冷藏并尽快食用。', '自制辅食泥建议分装。'], spoilageSigns: ['异味', '胀包', '分层异常', '霉点'] }, { ...baseRanges.shortFridge, fridge: { babyDaysMin: 1, babyDaysMax: 1, adultDaysMin: 1, adultDaysMax: 1, text: '开封后冷藏并尽快食用。' } })
]
