...
```bash
node --test tests/appConfig.test.js tests/assetPaths.test.js tests/babyAge.test.js tests/subscribeService.test.js tests/recognitionService.test.js tests/foodService.test.js tests/cloudStore.test.js tests/foodApiCore.test.js tests/foodRepository.test.js tests/foodRules.test.js
